...
$locamotion_locales = [
    'ach', 'af', 'bm', 'br', 'brx', 'ca', 'cy', 'dsb', 'ee',
    'en-ZA', 'es-MX', 'ff', 'ga-IE', 'gd', 'ha', 'hi-IN', 'hr',
    'hsb', 'ig', 'km', 'ln', 'lt', 'ms', 'my', 'oc', 'pt-PT',
    'sat', 'si', 'son', 'sw', 'ta', 'tl', 'tn', 'ur', 'uz',
    'vi', 'wo', 'xh', 'yo', 'zu',
];
...
$deadline = [
    ...
    'mozorg/home/index.lang'                 => '2015-06-01',
