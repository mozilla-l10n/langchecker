...
$locamotion_locales = [
    ...
    'ee', 'en-ZA', 'es-MX', 'fa', 'ff', 'fi', 'ga-IE', 'gd', 'ha',
    'hi-IN', 'hr', 'hsb', 'ig', 'kk', 'km', 'kok', 'ks', 'ln', 'lo',
    'lt', 'lv', 'mg', 'ms', 'my', 'nn-NO', 'oc', 'sat', 'si',
    'son', 'sw', 'ta', 'tl', 'tn', 'tsz', 'ur', 'uz', 'vi', 'wo',
    'xh', 'yo', 'zu',
];
...
$lang_flags['engagement'] = [
    ...
    'snippets/jun2015_a.lang'        => [ 'critical' => ['all'] ],
    'snippets/jun2015_b.lang'        => [ 'critical' => ['all'] ],
    'snippets/jun2015_c.lang'        => [ 'critical' => ['all'] ],
    'snippets/jun2015_d.lang'        => [ 'critical' => ['all'] ],
    'snippets/jul2015_a.lang'        => [ 'critical' => ['all'] ],
    'snippets/jul2015_b.lang'        => [ 'critical' => ['all'] ],
    'snippets/jul2015_c.lang'        => [ 'critical' => ['all'] ],
    'snippets/aug2015_a.lang'        => [ 'critical' => ['all'] ],
    'snippets/aug2015_b.lang'        => [ 'critical' => ['all'] ],
    'snippets/aug2015_c.lang'        => [ 'critical' => ['all'] ],
    'snippets/aug2015_win10.lang'    => [ 'critical' => ['all'] ],
    'snippets/sep2015.lang'          => [ 'critical' => ['all'] ],
    'snippets/sep2015_ios.lang'      => [ 'critical' => ['all'] ],
    ...
    'tiles/tiles_jul2015.lang'       => [ 'critical' => ['all'] ],
    'tiles/tiles_aug2015.lang'       => [ 'critical' => ['all'] ],
    'tiles/tiles_sep2015.lang'       => [ 'critical' => ['all'] ],
...
$deadline = [
    ...
    'mozorg/home/index.lang'                 => '2015-11-02',
    ...
    'teach/smarton/surveillance.lang'        => '2015-12-01',
